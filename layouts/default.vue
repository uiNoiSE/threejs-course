...
const path = computed(() => {
  return process.env.NODE_ENV === 'production' ? 'https://uinoise.github.io/threejs-course/' : '/';
})

useSeoMeta({
  title: 'Three.js Course',
  ogTitle: `uiNoiSE's Journey in Mastering Three.js: Unveiling the Power of 3D Web Graphics`,
  ...
  ogImage: `${path.value}sharing.jpg`,
  ...
  twitterImage: `${path.value}sharing.jpg`,
...
<template>
  <!--TODO: Add Header and Footer, style lil-gui positioning -
